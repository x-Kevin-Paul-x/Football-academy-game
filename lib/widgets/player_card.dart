  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        borderRadius:
            BorderRadius.circular(10.0), // Match card shape for ripple effect
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Chip(
                    ...
                    backgroundColor: _getPositionColor(player.naturalPosition)
                        .withOpacity(0.2),
              ...
              Wrap(
                // Use Wrap for chips to handle potential overflow
                spacing: 8.0, // Horizontal space between chips
                runSpacing: 4.0, // Vertical space between lines of chips
                children: [
                  _buildInfoChip(
                      context, Icons.cake_outlined, 'Age: ${player.age}'),
                  _buildInfoChip(context, Icons.attach_money_outlined,
                      'Wage: \$${player.weeklyWage}/wk'),
                ...
                children: [
                  ...
                  if (showPotential)
                    _buildSkillIndicator(
                      ...
                      color: Colors
                          .lightGreen, // Changed color slightly for better contrast
                    ),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Fatigue: ${player.fatigue.toStringAsFixed(1)}%',
              ...
              if (actions.isNotEmpty)
                Padding(
                  padding: const EdgeInsets.only(
                      top: 8.0), // Add some space above actions
                  child: Wrap(
