...
enum FormationType {
  // 11v11
  F442, F433, F352, F532, F4231, F4141,
  // 7v7
  F231, F321, F132,
  // 5v5
  F121, F211, F112,
...
final List<Formation> predefinedFormations = [
  // --- 11v11 ---
  Formation(
    id: 'f442_11', name: '4-4-2', type: FormationType.F442, tournamentType: TournamentType.elevenVeleven,
    positions: [
  ...
  Formation(
    id: 'f433_11', name: '4-3-3', type: FormationType.F433, tournamentType: TournamentType.elevenVeleven,
    positions: [
      PlayerPosition.Goalkeeper,
      PlayerPosition.Defender, PlayerPosition.Defender, PlayerPosition.Defender, PlayerPosition.Defender,
   ...
   Formation(
    id: 'f352_11', name: '3-5-2', type: FormationType.F352, tournamentType: TournamentType.elevenVeleven,
    positions: [
      PlayerPosition.Goalkeeper,
  ...
  // --- 7v7 ---
  Formation(
    id: 'f231_7', name: '2-3-1', type: FormationType.F231, tournamentType: TournamentType.sevenVseven,
    positions: [
   ...
   Formation(
    id: 'f321_7', name: '3-2-1', type: FormationType.F321, tournamentType: TournamentType.sevenVseven,
    positions: [
      PlayerPosition.Goalkeeper,
      PlayerPosition.Defender, PlayerPosition.Defender, PlayerPosition.Defender,
  ...
  // --- 5v5 ---
  Formation(
    id: 'f121_5', name: '1-2-1', type: FormationType.F121, tournamentType: TournamentType.fiveVfive,
    positions: [
   ...
   Formation(
    id: 'f211_5', name: '2-1-1', type: FormationType.F211, tournamentType: TournamentType.fiveVfive,
    positions: [
      PlayerPosition.Goalkeeper,
      PlayerPosition.Defender, PlayerPosition.Defender,
  ...
  // --- 3v3 ---
   Formation(
    id: 'f111_3', name: '1-1-1', type: FormationType.F111, tournamentType: TournamentType.threeVthree,
    positions: [
   ...
   Formation(
    id: 'f12_3', name: '1-2', type: FormationType.F12, tournamentType: TournamentType.threeVthree,
    positions: [
      PlayerPosition.Defender,
