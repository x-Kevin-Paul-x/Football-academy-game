...
String playerStatusToString(PlayerStatus status) {
  switch (status) {
    case PlayerStatus.Starter: return 'Starter';
    case PlayerStatus.Bench: return 'Bench';
    case PlayerStatus.Reserve: return 'Reserve';
    case PlayerStatus.Injured: return 'Injured';
    case PlayerStatus.LoanedOut: return 'Loaned Out';
