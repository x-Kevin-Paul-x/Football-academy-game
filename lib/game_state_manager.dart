...
class GameStateManager with ChangeNotifier {
  ...
  Future<bool> loadGame() async {
    try {
      ...
      // Sort news items by date descending (Newest First) to ensure consistent order
      // regardless of how they were stored in the save file.
      _newsItems = List<NewsItem>.from(loadedState.newsItems)
