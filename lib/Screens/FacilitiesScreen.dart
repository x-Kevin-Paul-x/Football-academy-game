        ...
        child: Column(
          ...
          children: [
            ...
            if (currentEffect != null && currentEffect.isNotEmpty) ...[ // <-- ADDED: Display current effect if provided
              ...
              Text(currentEffect, style: Theme.of(context).textTheme.bodySmall?.copyWith(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Cost: \$${NumberFormat.decimalPattern().format(upgradeCost)}',
                      style: TextStyle(
                        color: canAfford
                ...
                Tooltip(
                  message: canAfford
                      ? 'Upgrade for \$${NumberFormat.decimalPattern().format(upgradeCost)}'
                      : 'Insufficient funds. Need \$${NumberFormat.decimalPattern().format(upgradeCost)}',
                  child: ElevatedButton.icon(
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext dialogContext) {
                          return AlertDialog(
                            ...
                            content: Text('Upgrade $title to Level ${currentLevel + 1} for \$${NumberFormat.decimalPattern().format(upgradeCost)}?'),
                            actions: <Widget>[
                              TextButton(
                    ...
                    // Removed manual styleFrom to let Theme handle disabled state
                  ),
                ),
              ],
            ),
