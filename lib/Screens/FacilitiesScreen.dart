...
class FacilitiesScreen extends StatelessWidget {
  ...
  Widget _buildFacilityCard({
    ...
    required double balance, // Pass balance for tooltip calculation
    required VoidCallback onUpgrade, // Pass upgrade callback
  }) {
    final currencyFormat = NumberFormat.decimalPattern('en_US');

    final String tooltipMessage = canAfford
        ? 'Upgrade for \$${currencyFormat.format(upgradeCost)}'
        : 'Insufficient funds (Short by \$${currencyFormat.format(upgradeCost - balance)})';
