...
class StaffManagementScreen extends StatelessWidget {
  ...
  Widget _buildStaffList(BuildContext context, List<Staff> staffList, {required bool isHiredList}) {
    if (staffList.isEmpty) {
      return EmptyState(
        icon: isHiredList ? Icons.group_off : Icons.person_search,
        title: isHiredList ? 'No staff hired yet.' : 'No staff currently available.',
        message: isHiredList
            ? 'Hire staff to improve your academy operations.'
