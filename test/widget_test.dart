...
void main() {
  testWidgets('Start screen smoke test', (WidgetTester tester) async {
    ...
    // Wrap MyApp in ChangeNotifierProvider because MyApp expects to consume GameStateManager
    // which is normally provided by main(), but here we pump MyApp directly.
